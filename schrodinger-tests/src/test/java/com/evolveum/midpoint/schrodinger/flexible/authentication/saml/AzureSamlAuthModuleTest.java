...
public class AzureSamlAuthModuleTest extends AbstractSamlAuthModuleTest {
    ...
    protected void logoutAndCheckIt(String username) {
        $x(".//div[@id='login_workload_logo_text']").shouldBe(Condition.visible, MidPoint.TIMEOUT_DEFAULT_2_S);
    }
