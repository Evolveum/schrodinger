...
public class M5AccountsAssignmentsAndRoles extends AbstractLabTest {
    ...
    protected static final String LAB_OBJECTS_DIRECTORY = FUNDAMENTAL_LABS_DIRECTORY + "M5/";
    ...
    public void mod05test05DisableOnUnassign() throws IOException {
        addCsvResourceFromFileAndTestConnection(CSV_1_RESOURCE_FILE_5_5, CSV_1_RESOURCE_NAME, csv1TargetFile.getAbsolutePath());
    ...
    public void mod05test07ArchetypesIntroduction() {
        ...
        basicPage.listUsers().newObjectButtonClick("New "+ARCHETYPE_EMPLOYEE_LABEL.toLowerCase())
                .selectBasicPanel()
                    .form()
        ...
        Utils.addAssignmentsWithDefaultRelationAndSave(assigmentsTab, true, "Secret Projects I");
    }
}
