...
public class M6ConfiguringMultipleAccountTypes extends AbstractLabTest {
    ...
    public void mod06test01UsingAccountIntentsForProvisioning() throws IOException {
        ...
        addCsvResourceFromFileAndTestConnection(CSV_1_RESOURCE_FILE_6_1, CSV_1_RESOURCE_NAME, csv1TargetFile.getAbsolutePath());
        addCsvResourceFromFileAndTestConnection(CSV_2_RESOURCE_FILE_6_1, CSV_2_RESOURCE_NAME, csv2TargetFile.getAbsolutePath());
        addCsvResourceFromFileAndTestConnection(CSV_3_RESOURCE_FILE_6_1, CSV_3_RESOURCE_NAME, csv3TargetFile.getAbsolutePath());
