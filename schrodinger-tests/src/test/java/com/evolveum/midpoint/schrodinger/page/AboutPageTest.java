...
public class AboutPageTest extends AbstractSchrodingerTest {
    ...
    private static final String VERSION_EXPECTED = "4.9-SNAPSHOT"; // Static value, should be changed each version change.
    private static final String CONNID_VERSION_EXPECTED = "1.5.3.0"; // Static value, should be changed each version change.
