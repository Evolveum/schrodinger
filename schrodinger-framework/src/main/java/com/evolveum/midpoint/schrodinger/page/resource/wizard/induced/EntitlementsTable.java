...
public class EntitlementsTable<P> extends SelectableRowTable<P, EntitlementsTable<P>> {

    public EntitlementsTable(P parent, SelenideElement parentElement) {
        super(parent, parentElement);
    }

    @Override
    public EntitlementsTable<P> selectRowByName(String name) {
