...
public class StatisticsPanel<T> extends Component<T> {
    ...
    public StatisticsPanel<T> assertProvisioningOperationsResourceValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Provisioning operations resource value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertProvisioningOperationsObjectClassValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Provisioning operations object class value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertProvisioningOperationsGetOkValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Provisioning operations 'Get OK' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertProvisioningOperationsGetFailValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Provisioning operations 'Get Fail' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertProvisioningOperationsSearchOkValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Provisioning operations 'Search OK' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertProvisioningOperationsSearchFailValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Provisioning operations 'Search Fail' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertProvisioningOperationsCreateOkValueMatch(String expectedValue) {
        ...
        if (!Objects.equals(expectedValue, realValue)) {
            assertion.assertEquals(realValue, expectedValue, "Provisioning operations 'Create OK' value doesn't match, expected: " + expectedValue +
                    ", real: " + realValue);
        }
        return this;
    }
    ...
    public StatisticsPanel<T> assertProvisioningOperationsCreateFailValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Provisioning operations 'Create Fail' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertProvisioningOperationsUpdateOkValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Provisioning operations 'Update OK' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertProvisioningOperationsUpdateFailValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Provisioning operations 'Update Fail' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertProvisioningOperationsDeleteOkValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Provisioning operations 'Delete OK' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertProvisioningOperationsDeleteFailValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Provisioning operations 'Delete Fail' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertProvisioningOperationsSyncOkValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Provisioning operations 'Sync OK' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertProvisioningOperationsSyncFailValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Provisioning operations 'Sync Fail' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertProvisioningOperationsScriptOkValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Provisioning operations 'Script OK' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertProvisioningOperationsScriptFailValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Provisioning operations 'Script Fail' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertProvisioningOperationsOtherOkValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Provisioning operations 'Other OK' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertProvisioningOperationsOtherFailValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Provisioning operations 'Other Fail' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertProvisioningOperationsAllOperationsValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Provisioning operations 'All operations' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertProvisioningOperationsAvgTimeValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Provisioning operations 'Avg Time' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertProvisioningOperationsMinValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Provisioning operations 'Min Value' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertProvisioningOperationsMaxValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Provisioning operations 'Max Value' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertProvisioningOperationsTotalTimeValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Provisioning operations 'Total Time' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertMappingsEvaluationContainingObjectValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Mappings evaluation 'Containing object' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertMappingsEvaluationInvocationsCountValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Mappings evaluation 'Invocations count' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertMappingsEvaluationAvgTimeValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Mappings evaluation 'Avg Time' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertMappingsEvaluationMinValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Mappings evaluation 'Min' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertMappingsEvaluationMaxValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Mappings evaluation 'Max' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertMappingsEvaluationTotalTimeValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Mappings evaluation 'Total Time' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertNotificationsTransportValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Notifications 'Transport' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertNotificationsSuccessfulValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Notifications 'Successful' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertNotificationsFailedValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Notifications 'Failed' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertNotificationsAvgTimeValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Notifications 'Avg Time' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertNotificationsMinValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Notifications 'Min' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertNotificationsMaxValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Notifications 'Max' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
    ...
    public StatisticsPanel<T> assertNotificationsTotalTimeValueMatch(String expectedValue) {
        ...
        assertion.assertEquals(realValue, expectedValue, "Notifications 'Total Time' value doesn't match, expected: " + expectedValue +
                ", real: " + realValue);
        return this;
    }
