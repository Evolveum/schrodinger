...
public class PanelWithContainerWrapper<P> extends Component<P, PanelWithContainerWrapper<P>> {
    ...
    public <T extends PanelWithContainerWrapper<P>> PrismForm<T> formContainer(final String containerName) {
        SelenideElement element = getParentElement().$(Schrodinger.byElementAttributeValue("div", "aria-label", "Panel for container " + containerName));
        return new PrismForm<T>((T) this, element);
    }
}
