...
public class ListOrgsPage extends ObjectListPageWithPageRedirect<OrgsPageTable, OrgPage> {

    @Override
    public OrgsPageTable table() {
        return new OrgsPageTable(this, getTableBoxElement());
    }
    ...
    protected String getTableAdditionalClass(){
        return ConstantsUtil.OBJECT_ORG_BOX_COLOR;
    }
