...
public class CorrelationItemsTable<P> extends EditableRowTable<P, CorrelationItemsTable<P>> {

    public CorrelationItemsTable(P parent, SelenideElement parentElement) {
