...
public class WizardPage extends BasicPage {

    public static final String ID_WIZARD = "wizard";

    public SelenideElement getWizardPanelElement() {
        return $(Schrodinger.byDataId(ID_WIZARD)).shouldBe(Condition.visible, MidPoint.TIMEOUT_MEDIUM_6_S);
    }
