...
public class ArchetypePolicyPanel extends AssignmentHolderBasicPanel<ArchetypePage> {
    public ArchetypePolicyPanel(ArchetypePage parent, SelenideElement parentElement) {
