 ...
 * @author honchar
 */
public class MembersPanel<T> extends Component<T, MembersPanel<T>> {

    public MembersPanel(T parent, SelenideElement parentElement) {
        super(parent, parentElement);
    }

    public MemberPanel<MembersPanel<T>> membersPanel() {
